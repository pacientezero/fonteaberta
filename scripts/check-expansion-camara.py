...
def main() -> int:
    ...
    assert counts["fact_evidence_count"] == len(bundle["selected_deputies"])
    assert counts["claim_count"] == len(bundle["selected_deputies"])
    assert counts["claim_evidence_count"] == len(bundle["selected_deputies"])
    ...
    assert len(first["facts"]) == len(bundle["selected_deputies"])
    assert len(first["claims"]) == len(bundle["selected_deputies"])
    assert len(first["claim_evidences"]) == len(bundle["selected_deputies"])
