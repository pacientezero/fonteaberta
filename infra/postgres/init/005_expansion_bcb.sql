...
INSERT INTO directus_collections (
    ...
    ('economia', 'Folder for economic series', false, false, false, 'open', 'all', false, 'active', 21, 'folder', '#0891b2')
...
INSERT INTO directus_collections (
    ...
    ('economic_series', 'Official economic time series', false, false, true, 'open', 'all', false, 'active', 22, 'economia', 'chart-line', '#0ea5e9'),
    ('economic_observations', 'Observed points for economic series', false, false, true, 'open', 'all', false, 'active', 23, 'economia', 'table-clock', '#14b8a6')
ON CONFLICT (collection) DO UPDATE
SET
    note = EXCLUDED.note,
    hidden = EXCLUDED.hidden,
